...
from magikarp.report import hardcoded_indicator_ix, make_tokens_report, verification_plot
...
for model_id in UNUSED_TOKENS.keys():
    ...
    print(
        f"🛠️  Processing {model_id} ({indicator_ix=}) "
    ...
    try:
        ...
        if (
            ...
            _, threshold_2p = candidates_for_verification(token_infos, threshold_ratio=2)
